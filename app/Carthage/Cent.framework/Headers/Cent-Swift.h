...
@interface NSDate (SWIFT_EXTENSION(Cent))
...
/// :param day
/// :return Date
+ (NSDate * __nullable)fromYear:(NSInteger)year month:(NSInteger)month day:(NSInteger)day;

/// Returns a new Date given the unix timestamp
///
/// :param unix timestamp
/// :return Date
+ (NSDate * __nonnull)fromUnix:(double)unix;
...
/// :return Date
+ (NSDate * __nonnull)parse:(NSString * __nonnull)dateStr format:(NSString * __nonnull)format;
...
/// :param date
/// :return Double
+ (double)unix:(NSDate * __nonnull)date;
@end
