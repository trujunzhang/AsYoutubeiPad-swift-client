...
class VideoStatisticTableViewCell: UITableViewCell {
    ...
    // MARK: Configure cell
    func configureCell(object: VideoStatisticObject){
        self.likeCountLabel.titleLabel?.text = object.likeCount
        self.disLikeCountLabel.titleLabel?.text = object.disLikeCount
    }
